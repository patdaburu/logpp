...
latex_documents = [
    (master_doc, 'logpp.tex', 'logpp Documentation',
     'Pat Daburu', 'manual'),
]
...
man_pages = [
    (master_doc, 'logpp', 'logpp Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'logpp', 'logpp Documentation',
     author, 'logpp', 'One line description of project.',
     'Miscellaneous'),
]
